...
<html>
<head>
  <title>IUB Web Mall: Faculty of Agriculture and Environment</title>
    <meta charset="utf-8">
...
<div class="navbar">
  ...
  <div class="dropdown">
    <button class="dropbtn">Faculty of Agriculture and Environment
...
<!--Login Button Start-->
<div class="logbtn">
  <a href="login.html"><button class="signBtn" ><i class="fa fa-user"></i> Login</button></a>
</div>
<!--Login Button End-->
</div>
<!--Header End-->
...
<div class="category">
  <h1>Category: <span> Faculty of Agriculture and Environment</span></h1>
</div>
  ...
  <div class="column">
   <div class="box-wrapper">
    ...
    <div class="box-content">
      ...
      <p><a href="product-detail.html"><button>View Detail</button></a></p>
    </div>
    </div>
  </div>
