...
<html>
<head>
  <title>IUB Web Mall: Department of Chemistry</title>
    <meta charset="utf-8">
...
<div class="navbar">
  ...
  <div class="dropdown">
    <button class="dropbtn">Department of Chemistry
      <i class="fa fa-caret-down" id="caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="#">Institute of Physics</a>
      <a href="#">University College of Art and Design</a>
      <a href="#">Department of Electronics Engineering</a>
      <a href="#">Department of Electrical Engineering</a>  
      <a href="#">Department of Mechanical Engineering</a>  
      <a href="#">Faculty of Agriculture and Environment</a>
      <a href="#">Department of Civil Engineering</a>
    </div>
  </div> 
</div>
<!--Depart List End-->
...
<!--Search Icon start-->
<form action="">
  <input type="search" placeholder="What are you looking for...?" name="searchbtn">
...
<div class="category">
  <h1>Category: <span> Department Of Computer Science</span></h1>
</div>
   ...
   <div class="box-wrapper">
    ...
    <div class="box-content">
      ...
      <div class="description">
         chili description with red colour given for just demo and nothing else. understood!
      </div>
